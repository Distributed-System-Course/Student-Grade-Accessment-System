...
public class StudentController {
    ...
    void commitEventUpdate(){
        ...
        for(String projectName:names){
            ...
            String token="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";//personal
...
*/
  /*  //登录逻辑实现
    ...
    {
    @RequestParam("studentname") String studentname, @RequestParam("project") String project, HttpServletRequest request)
    {
