...
INSERT INTO `student` (`id`, `studentname`,`project`,`totalCommits`,`totalAddLines`,`totalDeleteLines`,`totalchangelines`) VALUES
...
INSERT INTO `commit` (`name`, `date`,`project`,`addLines`,`deleteLines`,`totalchangelines`) VALUES
